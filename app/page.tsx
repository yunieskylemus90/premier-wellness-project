...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div className="brand footer-brand"><span className="brand-mark">PW</span><span><strong>Premier Wellness</strong><small>Medical Center</small></span></div><p>{t.footer}</p><div className="footer-meta"><p>© 2026 Premier Wellness Medical Center</p><a className="admin-link" href="/admin">Panel de administración</a></div></footer><div className="mobile-cta"><a href="tel:+17868172979"><Phone size={18}/> {t.call}</a><a href="#inicio">{t.appointment}</a></div>
  </main>;
}
